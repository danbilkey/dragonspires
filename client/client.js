...
document.addEventListener('DOMContentLoaded', () => {
  ...
  imgTitle.src = "/assets/title.png";               // absolute path under /client
  let titleReady = false;
  imgTitle.onload = () => { titleReady = true; };
  imgTitle.onerror = () => { titleReady = false; };

  // Border (actual file name)
  const imgBorder = new Image();
  imgBorder.src = "/assets/game_border_2025.gif";   // absolute + correct filename
  ...
  // Player base atlas (old fallback)
